...
class KCF_Tracker(Base_Tracking):
    def __init__(self, correlation_type='gaussian', feature='gray'):
    ...
    def initiate(self, image, roi):
        ...
        self.window_sz = np.floor(np.multiply(self.target_sz, (self.padding)))  # (1 + self.padding)
    ...
    def update(self, image, detection):
        self.initiate(image, detection.roi)
